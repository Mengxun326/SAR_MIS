...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public long userRegister(String userAccount, String userPassword, String checkPassword, String userName, String userRole) {
        // 1. 校验
        ...
        if (!"user".equals(userRole) && !"teacher".equals(userRole) && !"admin".equals(userRole)) {
    ...
    public long getTeacherCount() {
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
        // 统计教师和管理员角色的用户
        queryWrapper.in("userRole", "teacher", "admin");

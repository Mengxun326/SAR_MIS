export default [
  ...
  // 学生信息管理
  {
    ...
    routes: [
      ...
      { path: '/student/add', component: './Student/Add', name: '添加学生', title: '添加学生 - 学生学籍管理系统' },
      { path: '/student/edit/:id', component: './Student/Edit', title: '编辑学生信息 - 学生学籍管理系统' },
  ...
  // 成绩管理
  {
    ...
    routes: [
      ...
      { path: '/score/add', component: './Score/Add', name: '录入成绩', title: '录入成绩 - 学生学籍管理系统' },
      { path: '/score/edit/:id', component: './Score/Edit', title: '编辑成绩 - 学生学籍管理系统' },
  ...
  // 课程管理
  {
    ...
    routes: [
      ...
      { path: '/course/add', component: './Course/Add', name: '添加课程', title: '添加课程 - 学生学籍管理系统' },
      { path: '/course/edit/:id', component: './Course/Edit', title: '编辑课程 - 学生学籍管理系统' },
  ...
  // 选课管理
  {
    ...
    routes: [
      ...
      { path: '/course-selection/manage', component: './CourseSelection/Manage', name: '选课管理', title: '选课管理 - 学生学籍管理系统' },
    ],
  },
  ...
  // 学籍异动
  {
    ...
    routes: [
      ...
      { path: '/status-change/approve', component: './StatusChange/Approve', name: '审批异动', title: '审批学籍异动 - 学生学籍管理系统' },
